...
export const metadata: Metadata = {
  ...
  title: {
    default: "Eldea — запах, который помнят",
    template: "%s — Eldea",
  },
  description:
    "Небольшой парфюмерный дом. Четырнадцать ароматов для женщин, мужчин и кого угодно, по одному правилу: не добавляем ничего, что делает аромат только приятнее.",
  openGraph: {
    type: "website",
    siteName: "Eldea",
    locale: "ru_RU",
    title: "Eldea — запах, который помнят",
    description:
      "Четырнадцать ароматов для женщин, мужчин и кого угодно. Сделаны не спеша, в Грассе и Лиссабоне.",
  },
