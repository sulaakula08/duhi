...
const PANELS = [
  {
    tier: "Верх",
    time: "0–10 минут",
    heading: "Что доходит первым",
    body: "Самые летучие материалы — цитрусовая корка, зелёные стебли, холодные специи. Они целиком определяют начало и успевают уйти раньше, чем вы что-то решите.",
    notes: ["Бергамот", "Лист инжира", "Морская соль", "Розовый перец", "Петитгрейн"],
  },
  {
    tier: "Сердце",
    time: "10 минут – 2 часа",
    heading: "Где аромат решает, чем он будет",
    body: "Цветы, смолы и древесина средней летучести. Именно это имеют в виду, когда говорят, что аромат наконец раскрылся.",
  ...
  },
  {
    ...
    body: "Тяжёлые медленные молекулы: они испаряются часами, а не минутами, и заодно удерживают на себе всё, что легче.",
...
export function NotesStrip() {
  ...
  if (!pinned) {
    return (
      ...
      >
        <header>
          <p className="label-xs text-accent">Как движется аромат</p>
