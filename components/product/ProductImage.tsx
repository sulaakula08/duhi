...
export function ProductImage({
  ...
  if (photo) {
    return (
      /**
       * Снимок кладётся на постоянную светлую подложку, а не на `bg-surface`.
       * Это принципиально: у прозрачного стекла нет своего цвета, оно
       * показывает то, что за ним. На тёмной теме вырезанный флакон изнутри
       * почернел бы, а гравировка на стекле пропала. Фиксированная подложка
       * держит стекло читаемым в обеих темах, а сама подложка вписана в них
       * рамкой и мягкой тенью.
       */
      <div
        className={cn(
          "relative h-full w-full overflow-hidden rounded-sm",
          "bg-[#f4f1ec] ring-1 ring-inset ring-black/5",
          className,
        )}
      >
        <Image
